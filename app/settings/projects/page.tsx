    ...
    return (
        <section className="min-w-0 flex-1">
                                ...
                                <div key={project.id} className="flex items-center justify-between gap-8 py-5">
                                    <div className="min-w-0">
                                        ...
                                        <div className="mt-2 flex flex-wrap gap-x-4 gap-y-1 text-xs text-fg-dim">
                                            <span>
                                                {checkedOutQuantity}{" "}
                                                {checkedOutQuantity === 1 ? "part" : "parts"}{" "} checked out
                                            </span>
            ...
            <section className="py-8">
                ...
                <p className="mt-1 text-sm text-fg-muted">{archivedProjects.length}{" "} archived{" "} {archivedProjects.length === 1 ? "project" : "projects"}</p>
                                ...
                                return (
                                    <div key={project.id} className="flex items-center justify-between gap-8 py-5">
                                        <div className="min-w-0">
                                            ...
                                            <div className="mt-2 flex flex-wrap gap-x-4 gap-y-1 text-xs text-fg-dim">
                                                <span>{historicalQuantity}{" "} {historicalQuantity === 1 ? "part" : "parts"}{" "} in project history</span>
                                                <span> Created by{" "}{creator}</span>
